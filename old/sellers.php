  ...
  <body class="mdl-demo mdl-color--grey-100 mdl-color-text--grey-700 mdl-base">
    <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
      ...
      <header class="mdl-layout__header mdl-layout__header--scroll mdl-color--primary">
        ...
        <div class="mdl-layout--large-screen-only mdl-layout__header-row">
         <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" weight="30px" height="30px" viewBox="0 0 612 612" style="enable-background:new 0 0 612 612;" xml:space="preserve">
            <g>
          ...
          <h3 style="padding-left:5px;">SaaSNomad Admin</h3>
        </div>
        <div class="mdl-layout--large-screen-only mdl-layout__header-row">
        </div>
        <div class="mdl-layout__tab-bar mdl-js-ripple-effect mdl-color--primary-dark">
          ...
          <a href="subscribers.html" class="mdl-layout__tab">Subscribers</a>
          <a href="analytics.html" class="mdl-layout__tab">Analytics</a>
                ...
                <table id="example" class="display nowrap" cellspacing="0" width="100%">
                  ...
                  <?php foreach($sellers as $seller) : ?>
                    <tr>
                        ...
                        <td><?php echo $seller->seller_role; ?></td>
                        <td><?php echo $seller->seller_country; ?></td>
                        <td><?php echo $seller->seller_company; ?></td>
                        <td><?php echo $seller->seller_product; ?></td>
                        <td><?php echo $seller->seller_industry; ?></td>
                        <td><?php echo $seller->seller_description; ?></td>
                        <td><?php echo $seller->seller_mrr; ?></td>
                        <td><?php echo $seller->seller_growth; ?></td>
                        <td><?php echo $seller->seller_employees; ?></td>
    ...
    <script src="js/admin/jsdataTables.material.min.js"></script>
    <script src="js/admin/dataTables.buttons.min.js"></script>
    <script src="js/admin/buttons.flash.min.js"></script>
