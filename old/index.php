                  ...
                  <div class="overlay-content" style="top:10%;">
                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-8  col-xs-12">
                                            <form id="buyerApplication" data-toggle="validator" role="form" style="margin: 0 auto;">
                                            <!--Email validation--> 
                                            ...
                                            <p style="color:#1de9b6;">Subscribe for Featured Listings<p>
                                                ...
                                                <div class="form-inline"> 
                                                    <button name="subscribe" type="submit" id="submit" class="btn btn-primary text-uppercase">Subscribe</button>   
                                                </div>
                                            </form>
                                            <script>
                                                $(document).ready(function(){  
                                                    $("#submit").click(function(){
                                                        ...
                                                        var buyer_company = $("#buyer_company").val();
                                                        var buyer_location = $("#buyer_location").val(); 
                                                        var buyer_industry = $("#buyer_industry").val(); 
                                                        // Returns successful data submission message when the entered information is stored in database.
                                                        var dataString = 'buyer_name='+ buyer_name + '&buyer_email='+ buyer_email + '&buyer_company='+ buyer_company + '&buyer_location='+ buyer_location + '&buyer_industry='+ buyer_industry;
